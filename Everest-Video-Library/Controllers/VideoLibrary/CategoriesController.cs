...
namespace Everest_Video_Library.Controllers.VideoLibrary
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,CategoryImage,Name")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,ImageUrl,Name")] Category category)
        {
            if (ModelState.IsValid)
            {
