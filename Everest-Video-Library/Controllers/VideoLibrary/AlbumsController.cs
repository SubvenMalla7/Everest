    ...
    public class AlbumsController : Controller
    {
       ...
       [AuthLog(Roles ="Manager")]
        public ActionResult Index()
        {
            ...
            var albums = db.Albums.Include(a => a.Catagory).Include(a => a.Producer).Include(a => a.Studio).OrderBy(a=>a.ReleaseDate);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.CatagoryId = new SelectList(db.Categories, "Id", "Description");
        ...
        public ActionResult Create([Bind(Include = "Id,ReleaseDate,NoOfCopies,Length,NoOfStock,CoverImage,AgeContent,Price,CatagoryId,ProducerId,StudioId,Name,Description")] Album album)
        {
            ...
            ViewBag.CatagoryId = new SelectList(db.Categories, "Id", "Description", album.CatagoryId);
